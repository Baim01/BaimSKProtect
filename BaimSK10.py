...
import SINGLEKILLER.LINE
from SINGLEKILLER.LINE.lib.curve.ttypes import *
from SINGLEKILLER.LINE.lib.curve.ttypes import Message
...
cl = SINGLEKILLER.LINE() #Self
cl.login(qr=True)
cl.loginResult()

ki = SINGLEKILLER.LINE() #bot1
ki.login(qr=True)
ki.loginResult()

ki2 = SINGLEKILLER.LINE() #bot2
ki2.login(qr=True)
ki2.loginResult()

ki3 = SINGLEKILLER.LINE() #bot3
ki3.login(qr=True)
ki3.loginResult()

ki4 = SINGLEKILLER.LINE() #bot4
ki4.login(qr=True)
ki4.loginResult()

ki5 = SINGLEKILLER.LINE() #bot5
ki5.login(qr=True)
ki5.loginResult()

ki6 = SINGLEKILLER.LINE() #bot6
ki6.login(qr=True)
ki6.loginResult()

ki7 = SINGLEKILLER.LINE() #bot7
ki7.login(qr=True)
ki7.loginResult()

ki8 = SINGLEKILLER.LINE() #bot8
ki8.login(qr=True)
ki8.loginResult()

ki9 = SINGLEKILLER.LINE() #bot9
ki9.login(qr=True)
ki9.loginResult()

ki10 = SINGLEKILLER.LINE() #bot10
ki10.login(qr=True)
ki10.loginResult()
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks For Add: By ѕιngle ĸιller тeaм",
    "lang":"JP",
    "comment":"Thanks For Add: By ѕιngle ĸιller тeaм",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
 ...
 #------------------------------------------------------------------
              ...
              if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    ki7.sendText(msg.to,"Fuck you !")
                    ki8.sendText(msg.to,"Fuck you !")
                    ki9.sendText(msg.to,"Fuck you !")
                    ki10.sendText(msg.to,"Fuck you !")
                    targets = []
                    for g in gs.members:
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                ki6.sendText(msg.to,"Pong 🤣")
                ki7.sendText(msg.to,"Pong 🤣")
                ki8.sendText(msg.to,"Pong 🤣")
                ki9.sendText(msg.to,"Pong 🤣")
                ki10.sendText(msg.to,"Pong 🤣")
#----------------------------------------------- 
#-----------------------------------------------
        if op.type == 19:
            try:
