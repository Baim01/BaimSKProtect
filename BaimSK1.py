...
from SINGLEKILLER.lib.curve.ttypes import Message
...
cl = SINGLEKILLER.LINE() #Selfmu
cl.login(token="Esvx0FqbHusNBlJOfa6f.a2jtIjiEA6OEd8Hqa7J97W.3b2xKXuLALNu2b19eqBMk9SqXhY8xAzd6zuwnL/aESs=")
cl.loginResult()

ki = SINGLEKILLER.LINE() #SK1
ki.login(token="Es90MUkLdSgnZ5OldCg9.JJp3+9nQAl9aBBedbFgVcq.PU4iRM7pLLYrU6j1zUNSiwZkb3XrTZv0kPRfsR++R14=")
ki.loginResult()
...
Bots = [mid,kimid]
admsa = "u03625388921e6baa1e0fc85003b8fdef"
...
#-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Tagall","Mentions","Sepi"]:
                  group = cl.getGroup(msg.to)
...
#---------------------------------------------------------
 ...
 #---------------------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"Respon tag On")
              
            elif msg.text in ["Respontag off","Autorespon:off","Respon off","Respon:off"]:
                wait["detectMention"] = False
                cl.sendText(msg.to,"Respon tag Off")   
                ...
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Leave set off 🎵")
                    else:
                        cl.sendText(msg.to,"Leave set off 🎵")
                else:
